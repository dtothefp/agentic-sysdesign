...
const TOOLS: Record<string, Tool> = {
  ...
  list_ratings: {
    ...
    fn: async ({ min_relevance, limit }) =>
      apiGet("/ratings", { min_relevance, limit: limit ?? 20 }),
  },
  list_recent_signals: {
  ...
  search_signals: {
    ...
    input_schema: {
      ...
      properties: {
        q: {
          type: "string",
          description: "free-text query; supports quoted phrases and -negation",
        },
        limit: {
          type: "integer",
          minimum: 1,
